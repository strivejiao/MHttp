package com.mobile.platform.mhttplibrary.http;

import android.content.Context;

import com.mobile.platform.mhttplibrary.http.callback.UCallback;
...
import com.mobile.platform.mhttplibrary.http.request.BaseHttpRequest;
import com.mobile.platform.mhttplibrary.http.request.GetRequest;
import com.mobile.platform.mhttplibrary.http.request.PostRequest;
import com.mobile.platform.mhttplibrary.http.request.RetrofitRequest;
import com.mobile.platform.mhttplibrary.http.request.UploadRequest;
...
public class VHttp {
     ...
     * @return
     */
    public static <T> GetRequest GET(String suffixUrl) {
     ...
     * @return
     */
    public static <T> PostRequest POST(String suffixUrl) {
